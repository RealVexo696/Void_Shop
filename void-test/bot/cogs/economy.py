...
Alle Befehle jetzt als /slash commands mit App-Karten UI Design (0x2b2d31).
"""
...
class EconomyCog(commands.Cog, name="EconomyCog"):
    ...
    # ==========================================================================
    # /verify SLASH COMMAND (App-Card Look 0x2b2d31)
    # ==========================================================================
    ...
    # ==========================================================================
    # /ffbuilder SLASH COMMAND (App-Card Look 0x2b2d31)
    # ==========================================================================
