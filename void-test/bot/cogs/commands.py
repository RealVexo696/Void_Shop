    ...
    async def help_command(self, interaction: discord.Interaction):
        ...
        embed = EmbedHelper.create_prestige_embed(
            ...
            description=(
                ...
                "~~                                                              ~~\n"
                "> **🎟️ TICKET-SYSTEM:**\n"
                "> Klicke im Kanal `#🎟️│create-ticket` auf die Buttons:\n"
                "> ▸ 🛒 **Produkt kaufen** — Kauf-Ticket erstellen\n"
                "> ▸ ⚙️ **Allgemeiner Support** — Support-Ticket erstellen\n"
                "> ▸ 🤝 **Partnerschaft** — Partner-Ticket erstellen\n"
                "~~                                                              ~~\n"
