...
Enthält !role und !Start Befehle mit sofortigem Berechtigungs-Check,
Rollenlimit-Prüfung und dynamischem Berechtigungssystem für alle 23 Rollen.
"""
    ...
    async def create_roles_command(self, ctx):
        ...
        for idx, (role_name, (color_hex, is_admin)) in enumerate(role_colors.items(), 1):
            ...
            try:
                ...
                if not new_role:
                    # SOFORTIGER ABBRUCH STATS 69 SEKUNDEN ZU WARTEN!
                ...
                # Optimierte 2.0s Pause gegen Discord API Rate-Limits
                await asyncio.sleep(2.0)
