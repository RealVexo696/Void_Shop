...
Rollenlimit-Prüfung und App-Karten UI Design (0x2b2d31) mit kompaktem Abstand und Button-Footer.
"""
...
class SetupConfirmationView(discord.ui.View):
    def __init__(self, ctx):
        ...
        self.ctx = ctx
        self.value = None
        self.add_item(discord.ui.Button(label="Powered by BotForge", style=discord.ButtonStyle.secondary, disabled=True, row=4, custom_id="footer_setup_confirm"))

    @discord.ui.button(label="🧹 Komplett neu aufsetzen", style=discord.ButtonStyle.danger, emoji="🧹", row=0)
    ...
    @discord.ui.button(label="➕ Nur hinzufügen", style=discord.ButtonStyle.success, emoji="➕", row=0)
    ...
    @discord.ui.button(label="❌ Abbrechen", style=discord.ButtonStyle.secondary, emoji="❌", row=0)
