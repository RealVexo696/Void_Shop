...
SETUP_ROLE_DELAY = 0.0
SETUP_CATEGORY_DELAY = 0.0
SETUP_CHANNEL_DELAY = 0.0
SETUP_PERMISSION_DELAY = 0.0
SETUP_PANEL_DELAY = 0.0
SETUP_PROGRESS_STEP = 10
...
async def perform_server_setup(guild:discord.Guild, actor:discord.Member, status_message, mode:str="add"):
    ...
    for idx, (name, rgb, hoist, mentionable) in enumerate(reversed(ROLE_DEFS), start=1):
        if idx == 1 or idx % SETUP_PROGRESS_STEP == 0 or idx == total_roles:
