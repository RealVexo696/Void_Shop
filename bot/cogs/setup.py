...
class SetupCog(commands.Cog, name="SetupCog"):
    ...
    # /setup SLASH COMMAND
    # ==========================================================================
    @app_commands.command(name="setup", description="Komplettes Server-Setup: Rollen, Kanaele, Rechte & Embeds")
    @app_commands.describe(
        modus="reset = loescht alles und baut neu auf, add = ergaenzt nur Fehlendes"
    )
    @app_commands.choices(modus=[
        app_commands.Choice(name="Komplett neu aufsetzen (loescht alles)", value="reset"),
        app_commands.Choice(name="Nur hinzufuegen (ergaenzt)", value="add"),
    ])
    ...
    async def setup_command(self, interaction: discord.Interaction, modus: str):
        ...
        await status_msg.edit(embed=EmbedHelper.create_prestige_embed(
            ...
            description=(
                ...
                "> **Schritt 2/4:** Erstelle Kategorien & Kanaele..."
        ...
        categories_layout = [
            ...
            },
            {
                ...
                "channels": [
                    ...
                    {"name": "fastflags", "type": "text", "topic": "FPS & Performance Optimierungen"},
                    {"name": "discord-templates", "type": "text", "topic": "Schicke Discord Server Vorlagen"},
                    {"name": "products", "type": "text", "topic": "Unsere Produkt- & Preisuebersicht"},
            ...
            },
            {
                ...
                "channels": [
                    ...
                    {"name": "faq", "type": "text", "topic": "Haeufig gestellte Fragen (FAQs)"},
                ],
            },
            {
                "name": "STAFF",
            ...
            },
            {
                ...
                "channels": [
                    ...
                    {"name": "message-logs", "type": "text", "topic": "Logs fuer geloeschte & editierte Nachrichten"},
                    {"name": "invite-logs", "type": "text", "topic": "Logs fuer erstellte & genutzte Einladungslinks"},
                    {"name": "join-leave-logs", "type": "text", "topic": "Logs fuer Serverbeitritte & Austritte"},
                    {"name": "ticket-logs", "type": "text", "topic": "Ticket-Protokolle & Transkripte"},
                    {"name": "system-logs", "type": "text", "topic": "System-Logs fuer Kanaele & Rollen"},
                    {"name": "security-logs", "type": "text", "topic": "Logs fuer blockierte Scam- & Phishing-Links"},
                ],
            },
        ]
            ...
            if not category:
                ...
                if not category:
                    await status_msg.edit(embed=EmbedHelper.create_prestige_embed(
                        ...
                        description=(
                            "> Ich kann keine Kategorien/Kanaele erstellen!\n\n"
                            "**Behebung:**\n"
        ...
        if c_buy:
            embed_buy = EmbedHelper.create_prestige_embed(
                ...
                description=(
                    ...
                    "Produkt kaufen"**. Ein privater Supportkanal wird nur fuer dich erstellt.\n\n"
        ...
        if c_ticket_panel:
            embed_ticket_panel = EmbedHelper.create_prestige_embed(
                title="VOID - Support & Kauf-Center",
                description=(
        ...
        await status_msg.edit(embed=EmbedHelper.create_prestige_embed(
            ...
            description=(
                ...
                "> **Embeds:** Alle Infos, Regeln, Tickets & Verifikation gesendet\n"
